...
namespace WindowsFormsApp1.View.Control
{
    ...
    public partial class AdressControl : UserControl
    {
        ...
        public void AdressChanged(object sender, EventArgs args)
        {
            //toolTipDescription.TipLabel(ApartamentBox, "Адрес изменился");
            MessageBox.Show("Адрес изменился", "Изменение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void PostIndexBox_MouseEnter(object sender, EventArgs e)
        {
            toolTipDescription.TipTextBox(sender, "Почтовый индекс города, где вы проживаете" +
            "\nПоле, обязательное к заполнению!");
        }

        private void CountryBox_MouseEnter(object sender, EventArgs e)
        {
            toolTipDescription.TipTextBox(sender, "Страна проживания" +
            "\nПоле, обязательное к заполнению!");
        }

        private void CityBox_MouseEnter(object sender, EventArgs e)
        {
            toolTipDescription.TipTextBox(sender, "Город, в котором проживаете" +
            "\nПоле, обязательное к заполнению!");
        }
        private void StreetBox_MouseEnter(object sender, EventArgs e)
        {
            toolTipDescription.TipTextBox(sender, "Улица, на которой проживаете" +
            "\nПоле, обязательное к заполнению!");
        }

        private void BuildingBox_MouseEnter(object sender, EventArgs e)
        {
            toolTipDescription.TipTextBox(sender, "Дом, в котором проживаете" +
            "\nПоле, обязательное к заполнению!");
        }


        private void ApartamentBox_MouseEnter(object sender, EventArgs e)
        {
            toolTipDescription.TipTextBox(sender, "Квартира, в которой проживаете" +
            "\nПоле, обязательное к заполнению!");
        }
